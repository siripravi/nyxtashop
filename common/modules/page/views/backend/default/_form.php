...
<?php $form = ActiveForm::begin([
     ...
     <div class="card-actions ml-auto p-2 text-right">
            <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Create') : Yii::t('app', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-flat btn-outline btn-success' : 'btn btn-flat btn-outline btn-success']) ?>
        </div>    
<div class="card card-warning card-tabs">
<ul class="full-width-tabs nav nav-tabs">
                    <li class="nav-item use-max-space"><a href="#tab-main" class="nav-link active" data-toggle="tab"><?= Yii::t('app', 'Main') ?></a></li>
                    <li class="nav-item use-max-space"><a href="#tab-images" class="nav-link" data-toggle="tab"><?= Yii::t('app', 'Images') ?></a></li>
                </ul> 
    <div class="card-body"> 
        <div class="tab-content">
           <div class="tab-pane show active" id="tab-main">
                ...
                <?= $form->field($model, 'status')->dropDownList(\common\modules\page\models\Page::getStatusList()) ?>
