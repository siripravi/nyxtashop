<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- Sidebar -->
    <div class="sidebar" style="background-image:url(<?= '/admin/img/sidebar-bg.jpg'?>)">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">Nyxta Admin</a>
            </div>
        </div>
            ...
            echo \hail812\adminlte\widgets\Menu::widget([
               // 'options' => ['class'=>'nav nav-pills nav-sidebar flex-column'],
                'items' => [
                    ...
                    ['label' => 'PRODUCT DATA', 'header' => true],
                    ['label' => 'Categories', 'url' => ['/admin/products/category/index'], 'icon' => 'th', 'badge' => '<span class="right badge badge-danger">New</span>'],
                    ['label' => 'Products', 'url' => ['/admin/products/default/index'], 'icon' => 'file-code'],
                    ['label' => Yii::t('app', 'Groups'), 'url' => ['/admin/products/complect/index']],
