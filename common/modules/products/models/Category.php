...
class Category extends ActiveRecord
{
    ...
    {
        return $this->hasMany(Feature::class, ['id' => 'feature_id'])->viaTable('nxt_feature_category', ['category_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Product::class, ['id' => 'product_id'])->viaTable('nxt_product_category', ['category_id' => 'id']);
    }
    ...
    public function getImages()
    {
        ...
        return $this->hasMany(Image::class, ['id' => 'image_id'])
            ->viaTable($name . '_image', [str_replace($prefix,"",$name) . '_id' => 'id'])
            ->leftJoin($name . '_image', 'id=image_id')
            ->where([$name . '_image.' . str_replace($prefix,"",$name) . '_id' => $this->id])
