...
/* @var $searchModel common\modules\page\models\Page */
...
<section class="page-default-index">
    ...
    <ul>
        <li><?= Html::a(Yii::t('page', 'page Categorys'), ['/admin/page/page-category']); ?></li>
        <li><?= Html::a(Yii::t('page', 'page Posts'), ['/admin/page/default']); ?></li>
        <li><?= Html::a(Yii::t('page', 'page Comments'), ['/admin/page/page-comment']); ?></li>
        <li><?= Html::a(Yii::t('page', 'page Tags'), ['/admin/page/page-tag']); ?></li>
    </ul>
</section>
