...
use app\modules\admin\models\Podbor;
...
/* @var $model app\modules\admin\models\Podbor */
        ...
        <div class="card-header">           
            <ul class="full-width-tabs nav nav-tabs">
                <?php foreach (Language::suffixList() as $suffix => $name) : ?>
                    <li class="nav-item use-max-space"><a href="#lang<?= $suffix ?>-tab" class="nav-link<?= empty($suffix) ? ' active': '' ?>" data-toggle="tab"><?= $name ?></a></li>
                <?php endforeach; ?>
                <li class="nav-item use-max-space"><a href="#tab-main" class="nav-link" data-toggle="tab"><?= Yii::t('app', 'Main') ?></a></li>
            </ul>                   
        </div>
        <div class="card-body">
