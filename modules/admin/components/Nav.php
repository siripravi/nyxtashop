...
class Nav extends Widget
{
     ...
     * @since 2.0.7
     */
    public $dropdownClass = 'app\modules\admin\components\Dropdown';
    ...
    public function renderItem($item)
    {
        ...
        $linkOptions = array_merge($this->linkOptions, $linkOptions);
        ...
        if ($active) {
            Html::addCssClass($linkOptions, $this->activeClass);
        }
    ...
    protected function isChildActive($items, &$active)
    {
        foreach ($items as $i => $child) {
            ...
            if (ArrayHelper::remove($items[$i], 'active', false) || $this->isItemActive($child)) {
                Html::addCssClass($items[$i]['options'], $this->activeClass);
