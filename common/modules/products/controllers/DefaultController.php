...
use common\modules\products\models\Model;
...
use common\modules\products\models\ProductSearch;
...
class DefaultController extends BaseAdminController
{
            ...
            if (!Yii::$app->request->isPjax) {
                ...
                if ($valid) {
                    ...
                    try {
                        ...
                        $transaction->rollBack();
                        //echo '<pre>'; print_r($e->errorInfo);die;
                    }
                }
            } else {  
    ...
    public function actionUpdate($id)
    {
       ...
       // echo '<pre>';  print_r($variantImages); die;
        $features = Feature::getObjectList(true, $model->category_ids);
