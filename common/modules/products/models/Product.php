...
class Product extends ActiveRecord
{
    ...
    {
        return $this->hasMany(Category::class, ['id' => 'category_id'])->viaTable('nxt_product_category', ['product_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Product::class, ['id' => 'option_id'])->viaTable('nxt_product_option', ['product_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Complect::class, ['id' => 'complect_id'])->viaTable('nxt_product_complect', ['product_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Status::class, ['id' => 'status_id'])->viaTable('nxt_product_status', ['product_id' => 'id']);
    }
