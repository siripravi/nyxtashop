...
/* @var $searchModel common\modules\cart\models\OrderProductSearch */
...
<div class="order-product-index">
    ...
    <div class="form-group field-order-buyer_id required">
        ...
        <div>
            ...
            <?= Html::a('<span class="fas fa-pencil"></span>', Url::to(['/admin/cart/buyer/update', 'id' => $order->buyer->id]), ['target' => '_blank']) ?>
        </div>
    </div>
