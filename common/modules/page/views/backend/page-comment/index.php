...
/* @var $searchModel \common\modules\page\models\pageCommentSearch */
        ...
        'columns' => [
            ...
            [
                ...
                /*'filter' => Html::activeDropDownList(
                    $searchModel,
                    'post_id',
                    \common\modules\page\models\pagePost::getArrayCategory(),
            ...
            [
                ...
                'format' => 'html',
                'value' => function ($model) {
                    if ($model->status === \common\modules\page\traits\IActiveStatus::STATUS_ACTIVE) {
                        $class = 'label-success';
                    } elseif ($model->status === \common\modules\page\traits\IActiveStatus::STATUS_INACTIVE) {
                        $class = 'label-warning';
                    } else {
                        $class = 'label-danger';
                    }
                ...
                'filter' => Html::activeDropDownList(
                    $searchModel,
                    'status',
                    \common\modules\page\models\Page::getStatusList(),
